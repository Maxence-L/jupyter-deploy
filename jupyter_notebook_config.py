...
#  Default: 'maxencelaumonier'
# c.Session.username = 'maxencelaumonier'
...
#  Default: 0
# c.MƒappingKernelManager.cull_idle_timeout = 0
...
#  Choices: any of ['sha3_384', 'md5', 'sha3_224', 'sha384', 'sha224', 'sha3_512', 'sha3_256', 'sha256', 'blake2b', 'blake2s', 'sha1', 'sha512']
#  Default: 'sha256'
